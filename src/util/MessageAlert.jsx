...
const MessageAlert = ({
  ...
  const alertStyles = {
    success: {
      container:
        "bg-teal-100 border-t-4 border-teal-500 rounded-b text-teal-900 px-4 py-3 shadow-md relative",
      icon: "fill-current h-6 w-6 text-teal-500 mr-4",
    },
    warn: {
      container:
        "bg-yellow-100 border-t-4 border-yellow-500 rounded-b text-yellow-900 px-4 py-3 shadow-md relative",
      icon: "fill-current h-6 w-6 text-yellow-500 mr-4",
    },
    error: {
      container:
        "bg-red-100 border-t-4 border-red-500 rounded-b text-red-900 px-4 py-3 shadow-md relative",
      icon: "fill-current h-6 w-6 text-red-500 mr-4",
    },
    info: {
      container:
        "bg-blue-100 border-t-4 border-blue-500 rounded-b text-blue-900 px-4 py-3 shadow-md relative",

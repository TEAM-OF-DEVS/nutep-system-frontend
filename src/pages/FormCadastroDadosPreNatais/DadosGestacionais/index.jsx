...
export function DadosGestacionais() {
  ...
  return (
    <>
      ...
      <div className="mt-8 px-8 space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          <FormField isGrid label="Descrição do Motivo da hospitalização" />
        </div>
        <div className="grid grid-cols-2 gap-4">
          <FormField isGrid label="Diagnóstico" isSelect options={diagnostico} />
          <FormField isGrid label="Descrição do Diagnóstico" />
        </div>
        <div className="grid grid-cols-2 gap-4">
          <FormField isGrid label="Observações" />
        </div>
      </div>
    </>
  );

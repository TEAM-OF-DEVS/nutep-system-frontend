...
export function FormCadastroDadosPreNatais() {
  ...
  const contraceptiveMethods = [
    ...
    "Anticoncepcional Injetável - Trimestral', 'Anticoncepcional oral",
    "Coito interrompido",
    "DIU",
    "Método tabela",
    "Preservativo",
  ...
  const doencasPreExistentesMae = [
    ...
    "Autoimune - Diabetes tipo 1",
    "Autoimune - Doença celíaca",
    "Autoimune - Esclerose múltipla",
    "Autoimune - Lupus eritematoso sistêmico",
    "Autoimune - Síndrome de Sjögren",
    "Autoimune - Tireóide de Hashimoto",
    "Autoimune - Vitiligo",
    "Cardiopatias - Angina",
    "Cardiopatias - Anomalia de Ebstein",
    "Cardiopatias - Arritmia",
    "Cardiopatias - Atresia pulmonar",
    "Cardiopatias - Comunicação interatrial",
    "Cardiopatias - Comunicação interventricular",
    "Cardiopatias - Defeito no septo atrioventricular",
    "Cardiopatias - Encocardite",
    "Cardiopatias - Infarto",
    "Cardiopatias - Insuficiência cardíaca",
    "Cardiopatias - Miocardite",
    "Cardiopatias - Pericardite",
    "Cardiopatias - Persistência do canal arterial",
    "Cardiopatias - tetralogia de Fallot",
    "Cardiopatias - transposição dos grandes vasos da base",
    "Cardiopatias - valvulopatia",
    "Distúrbio de coagulação - Coagulação intravascular disseminada",
    "Distúrbio de coagulação - Deficiência de alfa 2-antiplasmina",
    "Distúrbio de coagulação - Deficiência do fator II",
    "Distúrbio de coagulação - Deficiência do fator V",
    "Distúrbio de coagulação - Deficiência do fator VII",
    "Distúrbio de coagulação - Deficiência do fator X",
    "Distúrbio de coagulação - Deficiência do fator XI",
    "Distúrbio de coagulação - Hemofilia / Doença de von willebrand",
    "Distúrbio de coagulação - Trombocitopenia",
    "Doenças psiquiátricas - Esquizofrenia",
    "Doenças psiquiátricas - Psicose maníaco depressiva",
    "Doenças psiquiátricas - Psicose obsessiva compulsiva",
    "Doenças psiquiátricas - Transtorno bordeline",
    "Doenças psiquiátricas - Transtorno de ansiedade generalizada",
    "Doenças psiquiátricas - Transtorno dissociativo",
    "Doenças psiquiátricas - Transtorno do pânico",
    "Nenhuma",
    "Outros",
    "SI",
  ];
  const usoDrogasMae = [
    "Álcool - 1 a 4 vezes por semana",
    "Álcool - 11 a 20 vezes por semana",
    "Álcool - 5 a 10 vezes por semana",
    "Álcool - Mais de 20 vezes",
    "Cocaína - 1 a 4 vezes por semana",
    "Cocaína - 11 a 20 vezes por semana",
    "Cocaína - 5 a 10 vezes por semana",
    "Cocaína - Mais de 20 vezes",
    "Crack - 1 a 4 vezes por semana",
    "Crack - 11 a 20 vezes por semana",
    "Crack - 5 a 10 vezes por semana",
    "Crack - Mais de 20 vezes",
    "Fumo - 1 a 10 unidades por semana",
    "Fumo - 11 unidades a 20 unidades por semana",
    "Fumo - Mais de 20 unidades por semana",
    "Maconha - 1 a 4 vezes por semana",
    "Maconha - 11 a 20 vezes por semana",
    "Maconha - 5 a 10 vezes por semana",
    "Maconha - Mais de 20 vezes",
    "Nenhuma",
    "Outros",
    "SI",
  ];
  const examesRealizadosMae = [
    "Amniocentese - Alterado",
    "Amniocentese - Normal",
    "Biópsia cariótipo fetal - Alterado",
    "Biópsia cariótipo fetal - Normal",
    "Biópsia do vilo corial - Alterado",
    "Biópsia do vilo corial - Normal",
    "Cardiotocografia - Alterado",
    "Cardiotocografia - Normal",
    "Cordocentese - Alterado",
    "Cordocentese - Normal",
    "Ecocardiograma fetal - Normal",
    "Eletrocardiograma fetal - Alterado",
    "Glicose em jejum - Alterado",
    "Glicose em jejum - Normal",
    "Hemograma - Alterado",
    "Hemograma - Normal",
    "HIV - Alterado",
    "HIV - Normal",
    "MAPA - Alterado",
    "MAPA - Normal",
    "Perfil bioquímico fetal - Alterado",
    "Perfil bioquímico fetal - Normal",
    "Tipo sanguíneo e fator RH - Alterado",
    "Tipo sanguíneo e fator RH - Normal",
    "TORCH - Alterado",
    "TORCH - Normal",
    "VDRL - Alterado",
    "VDRL - Normal",
  ...
  const medicamentosUtilizadosMae = [
    ...
    "Analgésicos",
    "Antiabortivos",
    "Anti hipertensivo - Adalat",
    "Anti hipertensivo - Aldactone",
    "Anti hipertensivo - Atenelol",
    "Anti hipertensivo - Besilato de Anlodipino",
    "Anti hipertensivo - Captopril",
    "Anti hipertensivo - Carvedilol",
    "Anti hipertensivo - Diuress",
    "Anti hipertensivo - Enalapril",
    "Anti hipertensivo - Entresto",
    "Anti hipertensivo - Espironolactona",
    "Anti hipertensivo - Furosemida",
    "Anti hipertensivo - Hidroclorotiazida",
    "Anti hipertensivo - Hidroclorotizida",
    "Anti hipertensivo - Lasix",
    "Anti hipertensivo - Losartana",
    "Anti hipertensivo - Metildopa",
    "Anti hipertensivo - Nifedipina",
    "Anti hipertensivo - Seloken",
    "Anti hipertensivo - Valsartana",
    "Anti hipertensivo - Vasopril",
    "Psicotrópicos",
    "Nenhuma",
    "Outros",
    "SI",
